...
export async function taskAddCommand(title, options) {
    let taskTitle = title;
...
// Task View Command
// ============================================================================
export async function taskViewCommand(taskId) {
    ...
    try {
        ...
        if (task.assignedAgent) {
            console.log(`  ${chalk.cyan("Agent:")}        ${task.assignedAgent.name} (${formatStatus(task.assignedAgent.status)})`);
        }
...
export async function taskRunCommand(taskId, options) {
...
export async function taskCancelCommand(taskId, options) {
